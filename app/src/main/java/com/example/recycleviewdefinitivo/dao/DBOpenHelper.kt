        ...
        try {
            sqLiteDatabase.execSQL(
                "CREATE TABLE ${PeliculaContract.Companion.Entrada.TABLA}"
                        ...
                        + ",${PeliculaContract.Companion.Entrada.NOMBRECOL} NVARCHAR(20) NOT NULL"
                        + ",${PeliculaContract.Companion.Entrada.DESCRIPCIONCOL} NVARCHAR(150) NOT NULL"
                        + ",${PeliculaContract.Companion.Entrada.IMAGENCOL} int NOT NULL"
                        + ",${PeliculaContract.Companion.Entrada.DURACIONCOL} int NOT NULL"
                        + ",${PeliculaContract.Companion.Entrada.ANIOCOL} int NOT NULL"
                        + ",${PeliculaContract.Companion.Entrada.PAISCOL} NVARCHAR(20) NOT NULL)"
            )
        ...
        for (pelicula in lista) {
            db.execSQL(
                ("INSERT INTO ${PeliculaContract.Companion.Entrada.TABLA}("+
                        ...
                        " VALUES ('${pelicula.nombre}','${pelicula.descripcion}',${pelicula.img},${pelicula.duracion},${pelicula.anio},'${pelicula.pais}');")
            )
        }
    }
